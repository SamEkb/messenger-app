...
require (
	...
	github.com/SamEkb/messenger-app/pkg/platform/tracing v0.0.0-00010101000000-000000000000
...
replace github.com/SamEkb/messenger-app/pkg/platform/tracing => ../pkg/platform/tracing
